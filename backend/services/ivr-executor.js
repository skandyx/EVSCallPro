/**
 * Executes an IVR flow using the provided AGI channel from 'agi-async'.
        ...
        try {
            switch (currentNode.type) {
                ...
                case 'media':
                    ...
                    await channel.exec('TextToSpeech', `"${currentNode.content.prompt.replace(/"/g, '\\"')}"`);
                ...
                case 'menu':
                    ...
                    const digit = await channel.getData(currentNode.content.prompt, 5000, 1); // 5s timeout, 1 digit
                    let menuConnection;
                    if (digit) {
                ...
                case 'transfer':
                    ...
                    await channel.exec('Dial', `SIP/${currentNode.content.number}`);
